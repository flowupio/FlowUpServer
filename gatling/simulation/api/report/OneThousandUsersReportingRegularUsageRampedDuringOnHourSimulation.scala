...
/**
  ...
  */
class OneThousandUsersReportingRegularUsageRampedDuringOnHourSimulation extends Simulation {
  setUp(
    Report.oneUserUsingTheAppSomeTimesPerHourForSomeHours(2, 8).inject(rampUsers(1000) over 1.hours).protocols(httpConf)
  ).assertions(
